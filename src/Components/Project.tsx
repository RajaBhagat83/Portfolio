...
function Project() {
  ...
  return (
      <div className="mt-4 w-full ml-12 h-full flex flex-wrap ">
       <ProjectPart link="" image={buddy} alt="Buddy-finder" title="BuddySync" desc="A platform to discover, connect, and collaborate with compatible buddies" />
      ...
      <ProjectPart link="" image={coffee} alt="Landing-Page" title="Caffè Co" desc="Experience the taste of freshly crafted coffee (Landing Page )" />
